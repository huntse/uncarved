...
def lookup(hexa):
	...
	Wen sequence, its name, and the unicode character for the symbol"""
	_lookup = {
 		(7,7,7,7,7,7): (1, "Chien - The Creative (Heaven)", ䷀),
 		(8,8,8,8,8,8): (2, "Kun - The Receptive (Earth)", ䷁),
 		...
 		(8,7,7,7,7,7): (9, "Hsiao Chu -  The Taming Power of the Small", ䷈),
  		...
  		(7,8,7,7,9,8): (21, "Shih Ho - Biting Through", ),
